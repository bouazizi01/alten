...
- Imposer à l'utilisateur de se connecter pour accéder à l'API.
  ...
  * [POST] /token -> Permet de se connecter à l'application.  
    ...
    ```
    Une vérification devra être effectuée parmi tout les utilisateurs de l'application afin de connecter celui qui correspond aux infos fournies. 
  * Un token JWT sera renvoyé en retour de la reqûete.
